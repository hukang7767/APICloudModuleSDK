...
//		ECGGlobalSettings.setCollectMode(true);
//		//以下4个参数需要从爱心电后台申请后才可以使用，要使用自己公司的
//		ECGGlobalSettings.setAppId("axdVyfoslzB");
//		ECGGlobalSettings.setAppSecret("U2FsdGVkX18Xy3sUElX3IHIUAfRs8=");
//		ECGGlobalSettings.setEcgCardNo("12345");
//		ECGGlobalSettings.setEcgCardKey("12345");
	}
